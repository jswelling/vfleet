...
public:
...
#ifdef INT4BYTES
    register int v1= this->intval;
    register int v2= other.intval;
    register int r;
    register int t;
    t= (v1 & 255) + (v2 & 255);
    if (t & ~255) t= 255;
  ...
  {
    data[0]= (unsigned char)(data[0]*factor);
    data[1]= (unsigned char)(data[1]*factor);
    data[2]= (unsigned char)(data[2]*factor);
    data[3]= (unsigned char)(data[3]*factor);
    return *this;
  }
